...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ChinesefontChanged((*reinterpret_cast< std::add_pointer_t<QFont>>(_a[1]))); break;
        case 3: _t->EnglishfontChanged((*reinterpret_cast< std::add_pointer_t<QFont>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)(int )>(_a, &SettingsPage::volumeChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)(const QFont & )>(_a, &SettingsPage::ChinesefontChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)(const QFont & )>(_a, &SettingsPage::EnglishfontChanged, 3))
            return;
    }
}
