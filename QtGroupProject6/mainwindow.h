...
public:
    ...
    static int getGlobalScore() { return score; }
    static int getGlobalRound() { return round; }
    static void setGlobalScore(int val) { score = val; }
    static void setGlobalRound(int val) { round = val; }
...
private:
    ...
    QFont ChineseFont;
    QFont EnglishFont;
    void clearCurrentQuestion();  // 新增
    void loadNewQuestion();       // 修改后的新方法
public slots:
